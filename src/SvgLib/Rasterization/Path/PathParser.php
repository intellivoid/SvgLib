...
namespace SvgLib\Rasterization\Path;

/**
 * This class can convert SvgLib path description strings into arrays of distinct
...
class PathParser
{
     ...
     *
     * @param string $description The SvgLib path description to parse.
     *
