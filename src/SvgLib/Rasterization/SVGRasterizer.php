...
namespace SvgLib\Rasterization;

use InvalidArgumentException;
use SvgLib\Nodes\SVGNode;
use SvgLib\Utilities\Units\Length;
use SvgLib\Utilities\Colors\Color;
...
class SVGRasterizer
{
    ...
    /**
     * @param string $docWidth   The original SvgLib document width, as a string.
     * @param string $docHeight  The original SvgLib document height, as a string.
    ...
    /**
     * @return float The original SvgLib document width, in pixels.
     */
    ...
    /**
     * @return float The original SvgLib document height, in pixels.
     */
