...
namespace SvgLib\Utilities\Units;

final class Length
{
    /**
     * Converts any valid SvgLib length string into an absolute pixel length,
     ...
     *
     * @param string $unit       The SvgLib length string to convert.
