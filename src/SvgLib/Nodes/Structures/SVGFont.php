...
/**
 * Class SVGFont
 * @package SvgLib\Nodes\Structures
 */
class SVGFont extends SVGStyle
{
     ...
     * @param string      $name
     * @param string      $path
     * @param bool        $embed     Embed this font file directly in the SvgLib?
     * @param string|null $mimeType  The MIME-Type of the font file (only needed for embedding a font into the SvgLib)
     */
