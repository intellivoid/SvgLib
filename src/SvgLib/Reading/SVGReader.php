...
use SvgLib\SVG;
use SvgLib\Nodes\SVGNode;
use SvgLib\Nodes\SVGNodeContainer;
use SvgLib\Nodes\SVGGenericNodeType;
use SvgLib\Utilities\SVGStyleParser;

/**
 * This class is used to read XML strings or files and turn them into instances
 * of SvgLib by parsing the document tree.
 *
...
{
    /**
     * Parses the given string as XML and turns it into an instance of SvgLib.
    ...
    /**
     * Parses the given XML document into an instance of SvgLib.
     * Returns null when parsing fails.
     *
     * @param SimpleXMLElement $xml The root node of the SvgLib document to parse.
     *
     * @return SVG|null An image object representing the parse result.
     */
     ...
     *
     * Since styles in SvgLib can also be expressed with attributes, this method
