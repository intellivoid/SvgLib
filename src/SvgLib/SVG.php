...
use SvgLib\Nodes\Structures\SVGDocumentFragment;
use SvgLib\Rasterization\SVGRasterizer;
use SvgLib\Reading\SVGReader;
use SvgLib\Writing\SVGWriter;

/**
 * This is the main class for any SvgLib image, as it hosts the document root and
...
class SVG
{
     ...
     * SvgLib as accurately as possible (with PHP's limited imaging functions).
     * Note that, since images in SvgLib have an innate size, the given size only
